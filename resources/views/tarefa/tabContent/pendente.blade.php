@if ($tarefas->where('status', 'pendente')->isEmpty())
  <div class="alert alert-success text-center" role="alert">
    <p class="card-text fw-bold">Nenhuma tarefa pendente</p>
  </div>
@else
            ...
            <div class="card-body text-uppercase text-center">
              ...
              <form id="updateFormTarefa" method="POST"
                ...
                <select name="status" onchange="this.form.submit()">
                  ...
                  <option value="pendente" selected disabled>Pendente</option>
...
@if (session('active_tab_tarefa') === 'pendente')
  @include('tarefa.show')
  @if (auth()->user()->chefe)
    @include('tarefa.edit')
  @endif
