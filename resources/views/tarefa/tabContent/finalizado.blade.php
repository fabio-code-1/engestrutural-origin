@if ($tarefas->where('status', 'finalizado')->isEmpty())
  <div class="alert alert-success text-center" role="alert">
    <p class="card-text fw-bold">Nenhuma tarefa finalizada</p>
  </div>
@else
            ...
            <div class="card-body text-uppercase text-center">
              ...
              <form id="updateFormTarefa" method="POST"
                ...
                <select name="status" onchange="this.form.submit()">
                  ...
                  <option value="finalizado" selected disabled>Finalizado</option>
...
@if (session('active_tab_tarefa') === 'finalizado')
  @include('tarefa.show')
  @if (auth()->user()->chefe)
    @include('tarefa.edit')
  @endif
