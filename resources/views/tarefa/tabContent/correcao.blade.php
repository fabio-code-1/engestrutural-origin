@if ($tarefas->where('status', 'correcao')->isEmpty())
  <div class="alert alert-success text-center" role="alert">
    <p class="card-text fw-bold">Nenhuma tarefa para correção</p>
  </div>
@else
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
    @foreach ($tarefas as $tarefa)
      @if ($tarefa->status == 'correcao')
        <div class="col mb-4">
          <div class="card">
            @php
            ...
            <div class="card-body text-uppercase text-center">
              ...
              <form id="updateFormTarefa" method="POST"
                ...
                <select name="status" onchange="this.form.submit()">
                  ...
                  <option value="correcao" selected disabled>Correção</option>
                </select>
              </form>
...
@if (session('active_tab_tarefa') === 'correcao')
  @include('tarefa.show')
  @if (auth()->user()->chefe)
    @include('tarefa.edit')
  @endif
