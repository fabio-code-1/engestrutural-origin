@if ($arquivos->where('categoria', 'arquiteto')->isEmpty())
  <div class="alert alert-success text-center" role="alert">
    <p class="card-text fw-bold">Nenhum arquivo de arquitetura.</p>
  </div>
@else
  <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
    @foreach ($arquivos as $arquivo)
      @if ($arquivo->categoria == 'arquiteto')
        <div class="col mb-4">
          <div class="card">
            <div class="card-header text-uppercase fw-bolder d-flex justify-content-between align-items-center">
              <span
                style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 200px;">{{ $arquivo->user->name }}</span>
              <div class="d-flex">
